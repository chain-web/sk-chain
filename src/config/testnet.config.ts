...
export const genesis: GenesisConfig = {
  ...
  stateRoot: '0000000000000000000000000000000000000000000000',
  transactionsRoot: '0000000000000000000000000000000000000000000000',
  receiptRoot: '0000000000000000000000000000000000000000000000',
